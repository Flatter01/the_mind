...
class StudentRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDebtor = student.status.toLowerCase().contains('qarzdor') ||
        student.status.toLowerCase().contains('должник');
    final isTrial = student.status.toLowerCase().contains('trial') ||
      ...
      child: Container(
        ...
        child: Row(
          children: [
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: Text(_initials, style: TextStyle(color: _avatarColor, fontWeight: FontWeight.w700, fontSize: 13)),
                  ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14, color: Color(0xFF1A2233)),
                      ),
                    ],
                  ),
                ],
            ...
            Expanded(
              flex: 2,
              child: Text(student.phone ?? '', style: TextStyle(fontSize: 13, color: Colors.grey[700])),
            ),
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(student.groupName ?? '', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF1A2233))),
                  Text(student.teacherName ?? '', style: TextStyle(fontSize: 11, color: Colors.grey[400])),
                ],
              ),
            ),
            ...
            Expanded(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: balanceNegative ? const Color(0xFFED6A2E) : const Color(0xFF1A2233),
                ),
              ),
            ),
            ...
            Expanded(
              ...
              child: PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'delete') debugPrint("Удалить: ${student.firstName}");
                  if (value == 'freeze') debugPrint("Заморозить: ${student.firstName}");
                },
