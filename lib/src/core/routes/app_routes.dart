...
final GoRouter appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: AppPages.exams,
      builder: (context, state) => const TheMindExamsPage(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (context, state) => const TheMindTeacherPage(),
    ),
    GoRoute(
      path: AppPages.teacherGroup,
      builder: (context, state) => const TheMindTeacherGroupPage(),
    ),
    GoRoute(
